...
def generate_step(prompt, conv):
    # print('prompt', prompt)
    print("convsepc",conv.sep)
    stop_str = conv.sep if conv.sep_style == conversation.SeparatorStyle.SINGLE else conv.sep2
...
args.debug = False
os.chdir('/content/drive/MyDrive/Self_Reflection_Medical-main/FastChat-main/fastchat')
print(os.getcwd())
...
with jsonlines.open(args.input_file) as reader:
    ...
    for i, line in tqdm(enumerate(reader), total=len(reader)):
        ...
        print("Keys in conversation.conv_templates:", conversation.conv_templates.keys())
        conv = conversation.conv_templates[args.conv_template].copy()
